return {
    ...
    misc = {
        dictionary = {
            ...
            grdl_k_entry_fee_title = "Entry Fee",
            grdl_k_entry_fee_insufficient_title = "Entry Fee Required",
            grdl_k_entry_fee_blocked = "Gradelatro progress disabled.",
            grdl_k_entry_fee_glhf = "Good Luck, Have Fun!",
            grdl_b_entry_fee_reselect = "Reselect",
            grdl_b_entry_fee_continue = "Continue",
        ...
        v_dictionary = {
            ...
            grdl_k_entry_fee_balance = "Balance: G#1#",
            grdl_k_entry_fee_required = "Required: G#1#",
