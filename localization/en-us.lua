return {
    ...
    misc = {
        dictionary = {
            ...
            grdl_k_carry_active = "In Play",
            grdl_k_status_carried = "Carried",
            grdl_k_reason_carry_taken = "Another card is already carried.",
            grdl_k_reason_carry_locked = "The carried card is locked in for this run.",
            grdl_k_reason_not_in_run = "Carry a card during a run.",
            grdl_k_reason_no_carry = "No card is being carried.",
            ...
            grdl_k_reason_already_active = "The carried card is already in play.",
