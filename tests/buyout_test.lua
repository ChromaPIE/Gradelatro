...
H.assert_equal(buy_state.cards[1].acquired_month, 1, "purchase month from run start")
H.assert_equal(buy_state.cards[1].acquired_day, 1, "purchase day from run start")
H.assert_equal(buy_state.cards[1].acquired_price, 149, "purchase price stored")
