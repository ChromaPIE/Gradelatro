...
H.assert_equal(first.amount, 45, "red settlement amount")
H.assert_equal(state.currency_g, 55, "settlement adds currency")
...
H.assert_equal(state.currency_g, 55, "duplicate keeps currency")
