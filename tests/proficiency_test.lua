...
H.assert_equal(Proficiency.set_badge_colour(high, "#00ff80").ok, true, "badge colour accepts hash hex")
H.assert_equal(high.proficiency.badge_colour, "00FF80", "badge colour stored upper no hash")
H.assert_equal(Proficiency.set_badge_colour(high, "pink").reason, "invalid_hex", "bad badge colour rejected")
H.assert_equal(Proficiency.set_badge_colour(high, "").ok, true, "empty clears badge colour")
H.assert_equal(high.proficiency.badge_colour, nil, "badge colour cleared")
